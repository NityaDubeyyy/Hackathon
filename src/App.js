    ...
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        >
          ...
          <BottomNavigationAction label="Suppliers" value="/suppliers" icon={<StoreIcon />} />
          <BottomNavigationAction label="My Account" value="/my-account" icon={<AccountCircleIcon />} />
          <BottomNavigationAction label="Vendors" value="/vendors" icon={<GroupsIcon />} />
          <BottomNavigationAction label="Contact Us" value="/contact" icon={<ContactMailIcon />} />
        </BottomNavigation>
      </Paper>
    </ThemeProvider>
  );
